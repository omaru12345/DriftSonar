...
- [ ] GitHub Pages または外部サービスでホスト → リポジトリの Settings → Pages で `docs/` フォルダを公開し、URL `https://<user>.github.io/<repo>/privacy-policy.html` を App Store Connect に登録（手動・要リモートリポジトリ）
